        ...
        data: [
          {
            ...
            duties: [
              ...
              'Chatbot development and support',
              'Development and implementation of core functionality and support tools',
              'Database design',
              'Architecture of application',
              'Investigating alternatives and implementing better solutions',
          ...
          },
          {
            ...
            duties: [
              ...
              'Develop company products (Front-end, Backend)',
              'Code review and refactoring',
              'Mentoring development team members',
              'Training courses, workshops, meetings.',
              'Creating, organize and standardize the development process',
              'Interviews',
            ],
          },
          {
